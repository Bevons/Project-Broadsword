(function ($) {
    ...
    var methods = {
        init: function (params) {
            ...
            if( options.initialValue != undefined ) {
              ...
              colorSquare.css('color', options.initialValue );
            }
        }
    }
    ...
    $.fn.colorPalettePicker.defaults = {
        ...
        palette: ['blue', 'cyan', 'darkcyan', 'darkorange', 'darkorchid', 'fuchsia', 'gold', 'green', 'lightblue', 'lightgreen', 'lime', 'navy', 'orange', 'red', 'yellow', 'white'],
        lines: 1,
        bootstrap: 4,
        onSelected: null,
